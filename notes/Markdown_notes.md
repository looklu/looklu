...
例如：如果你想要用星号加在文字旁边的方式来做出强调效果，但不使字体倾斜，你可以在星号的前面加上反斜杠：
\*literal asterisks\*
`\*literal asterisks\*`
...
[声明值]: 参考链接link "title"
[1]:http://www.biying.com "只需修改这一处即可完成所有引用1的改变"
...
使用锚点，可以跳转到文档中的指定位置。同目录中点击章节进行跳转一样。还有下一节的注脚。这些根本上都是用锚点来实现的，只支持在标题后插入锚点，其它地方无效。
